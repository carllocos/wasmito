...
import { AddBreakpointRequest, RemoveBreakpointRequest } from './breakpoint_request';
...
export class WARDuinoRuntimeAPI implements RuntimeToolAPI {
  ...
  async addBreakpoint(breakpoint: Breakpoint, timeout?: number): Promise<boolean> {
  ...
  async removeBreakpoint(breakpoint: Breakpoint, timeout?: number): Promise<boolean> {
    const addr = breakpoint.wasmAddress;
  ...
  pause(timeout?: number): Promise<void> { throw new Error("To implement"); }
  breakpointPolicy(): BreakpointPolicy { throw new Error("To implement"); }
  changeBreakpointPolicy(p: BreakpointPolicy): void { throw new Error("To implement"); }
  proxify(timeout?: number): Promise<void> { throw new Error("To implement"); }
  uploadSourceCode(sourceCodeCompilationArgs: any, timeout?: number): Promise<boolean> { throw new Error("To implement"); }
  inspect(neededState: StateRequest, timeout?: number): Promise<WasmState> { throw new Error("To implement"); }
  snapshot(timeout?: number): Promise<WasmState> { throw new Error("To implement"); }
  loadWasmState(state: WasmState, timeout?: number): Promise<void> { throw new Error("To implement"); }
  resolveEvent(timeout?: number): Promise<void> { throw new Error("To implement"); }
  unregisterFuncForProxyCall(funcToProxy: WASMFunction, timeout?: number): Promise<boolean> { throw new Error("To implement"); }
  registerFuncForProxyCall(funcToProxy: WASMFunction, timeout?: number): Promise<boolean> { throw new Error("To implement"); }
  functionsProxied(): Set<WASMFunction> { throw new Error("To implement"); }
  proxyCall(funcid: number, args: WASM.Value[], timeout?: number): Promise<ProxyCallResponse> { throw new Error("To implement"); }
  addHookBefore(sourceCodeLocation: SourceCodeLocation, hook: Hook, timeout?: number): Promise<boolean> { throw new Error("To implement"); }
  addHookAfter(sourceCodeLocation: SourceCodeLocation, hook: Hook, timeout?: number): Promise<boolean> { throw new Error("To implement"); }
  addHookBeforeSrcNode(node: SourceCFGNode, hook: Hook, timeout?: number): Promise<boolean> { throw new Error("To implement"); }
  addHookOnNewEvent(hook: Hook, timeout?: number): Promise<boolean> { throw new Error("To implement"); }
  addHookOnEventHandling(hook: Hook, timeout?: number): Promise<boolean> { throw new Error("To implement"); }
  addHookOnError(hook: Hook, timeout?: number): Promise<boolean> { throw new Error("To implement"); }
  subscribeOnNewEvent(cb: (ev: WASM.Event) => void, timeout?: number): Promise<boolean> { throw new Error("To implement"); }
}
